...
# For screen
SCREEN_2FA_ENROLL = _("Enroll Two-Factor Device")
SCREEN_2FA_ENROLL_VERIFY = _("Verify Enrolled Two-Factor Device")
SCREEN_2FA_VERIFY = _("Verify Two-Factor Device")
SCREEN_ABOUT_US = _("About Us")
SCREEN_CONFIRM_SIGNUP = _("Confirm Your Sign-Up")
SCREEN_FORGOT_PASSWORD = _("Forgot Password")
SCREEN_HOME = _("Home")
SCREEN_MYPAGE = _("My Page")
...
PLACEHOLDER_COMPANY_NAME = _("Umbrella Corporation")
PLACEHOLDER_CONFIRM_PASSWORD = _("Re-enter your password")
PLACEHOLDER_DEPARTMENT = _("Research and Development")
PLACEHOLDER_DISPLAY_NAME = _("Johnny")
PLACEHOLDER_EMAIL = _("email@example.com")
PLACEHOLDER_FACTOR_NAME = _("Pixel 7a")
PLACEHOLDER_FIRST_NAME = _("John")
PLACEHOLDER_FULL_NAME = _("John Doe")
PLACEHOLDER_JOB_TITLE = _("IT Engineer")
PLACEHOLDER_LAST_NAME = _("Doe")
PLACEHOLDER_PASSWORD = _("Enter your password")
PLACEHOLDER_PHONE_NUMBER = _("Enter your phone number")
PLACEHOLDER_USERNAME = _("john.doe")

# For authentication label
FORM_LABEL_ACCEPT_TERMS = _("Accept Terms & Conditions")
